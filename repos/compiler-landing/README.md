...
This folder contains the Compiler landing page.

- Open `index.html` in a browser to view locally.
- Assets referenced are expected under `assets/` relative to this folder.

To publish:
1. Create a private GitHub repo (e.g. `compiler-landing`) and push this folder.
...
```bash
# from this folder
gh repo create <your-org-or-username>/compiler-landing --private --source=. --remote=origin
git branch -M main
